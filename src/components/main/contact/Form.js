...
export default function Form({ props }) {
  ...
  return (
    <div className="py-8 text-base min-w-2xl leading-7 space-y-6 text-gray-600">
      <h3 className="uppercase font-medium text-sm tracking-widest text-white">
        Send us a message
      </h3>
      <form className="flex flex-col gap-2 w-full" onSubmit={handleSubmit}>
        <div>
          <label className="block font-medium text-gray-100" htmlFor="name">
            Name
          </label>
          <input
            id="name"
        ...
        <div>
          <label className="block font-medium text-gray-100" htmlFor="email">
            Email
          </label>
          <input
            id="email"
        ...
        <div>
          <label className="block font-medium text-gray-100" htmlFor="subject">
            Subject
          </label>
          <input
            id="subject"
        ...
        <div className="">
          <label className="block font-medium text-gray-100" htmlFor="message">
            Message
          </label>
          <textarea
            id="message"
